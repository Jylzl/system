...
<template>
	<div class="content-list">
		<el-tabs v-model="activeName">
					...
					<div class="ct-footer">
						<div class="ct-footer-left">
							...
							>
								...
								<el-form-item>
									<el-dropdown>
										<el-button type="primary">改变内容状态</el-button>
										<el-dropdown-menu slot="dropdown">
											<el-dropdown-item>
												<el-button type="text" icon="el-icon-link">全部下线</el-button>
											</el-dropdown-item>
											<el-dropdown-item>
												<el-button type="text" icon="el-icon-delete">全部删除</el-button>
											</el-dropdown-item>
										</el-dropdown-menu>
									</el-dropdown>
								</el-form-item>
								<el-form-item>
									<el-dropdown size="small">
										<el-button type="primary">改变内容类型</el-button>
										<el-dropdown-menu slot="dropdown">
											<el-dropdown-item>
			...
			<el-tab-pane label="已归档" name="third">已归档</el-tab-pane>
		</el-tabs>
