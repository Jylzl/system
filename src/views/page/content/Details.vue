	...
	>
				...
				<el-header class="form-box-header" height="40px">
					...
					<div>
						...
						<el-tooltip class="item" effect="dark" content="清空" placement="top">
							<el-button type="text" icon="el-icon-delete" size="mini" circle></el-button>
						</el-tooltip>
					</div>
				</el-header>
		...
		<el-aside width="300px">
			<el-tabs type="border-card" v-model="tabsTwoActiveName" class="h100 form-tabs form-right-tabs">
				<el-tab-pane label="基本属性" name="first" class="h100">
					<div :class="{ 'form-bg-two': !obj.column.length }" class="h100">
						<el-scrollbar class="h100">1</el-scrollbar>
					</div>
				</el-tab-pane>
				<el-tab-pane label="多维度管理" name="second" class="h100">
					<div class="h100">
